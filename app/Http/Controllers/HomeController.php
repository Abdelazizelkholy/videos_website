...
class HomeController extends Controller
{
    ...
    public function category($id){
        ...
        return view('front_end.category.index' , compact('videos' , 'cat'));
    }

     public function video($id){

        $video = Video::with('skills' , 'tags' , 'cat' , 'user' , 'comments.user')->findOrFail($id);
        return view('front_end.video.index' , compact('video'));
    }
    ...
    public function skills($id){
        ...
        return view('front_end.skill.index' , compact('videos' , 'skill'));
    }
     ...
     public function tags($id){
        ...
        return view('front_end.tag.index' , compact('videos' , 'tag'));
    }
    ...
    public function page($id , $slug = null){
        ...
        return view('front_end.page.index' , compact('page'));
    }

    public function profile($id , $slug = null){
        $user = User::findOrFail($id);
        return view('front_end.profile.index' , compact('user'));
    }
